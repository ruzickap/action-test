...
* Static page generated by [Hugo](https://gohugo.io/)
  with checked links: [example](https://github.com/ruzickap/xvx.cz/blob/master/.github/workflows/hugo-build.yml)

* Static page generated by [VuePress](https://vuepress.vuejs.org/)
   with checked links: [example](https://github.com/ruzickap/k8s-harbor/blob/master/.github/workflows/build.yml)
